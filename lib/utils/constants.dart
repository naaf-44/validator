...
class Constants {
  ...
  static const String minLengthErrorMessage = "Field should contain at least %s characters.";
  static const String maxLengthErrorMessage = "Field should not exceed %s characters.";
  ...
  static const String minPasswordLengthErrorMessage = "Password should contain at least %s characters.";
  static const String maxPasswordLengthErrorMessage = "Password should not exceed %s characters.";

  // Email validation message messages
  static const String emptyEmailErrorMessage = "Please enter the email address.";
  static const String invalidEmailErrorMessage = "Please enter the valid email address.";

  // Phone number validation messages
  static const String emptyPhoneNumberErrorMessage = "Please enter the phone number.";
  static const String maxPhoneNumberLengthErrorMessage = "Phone number should not exceed %s digits.";
  static const String alphabetPhoneNumberErrorMessage = "Please enter only the numbers.";

  // Url  validation messages
  static const String emptyUrlErrorMessage = "Please enter the URL. ex: https://www.url.com";
  static const String invalidUrlErrorMessage = "Please enter the valid URL. ex: https://www.url.com";
